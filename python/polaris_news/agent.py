"""
Polaris Universal Agent Connector
...
class Agent:
    ...
    The simplest way to add financial intelligence to any AI agent.

        agent = Agent(api_key="pr_live_...")
        result = agent.ask("What's happening with NVDA?")
        print(result.summary)
    """
