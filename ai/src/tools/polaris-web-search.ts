...
export const polarisWebSearch = (options: { apiKey?: string } = {}) =>
  tool({
    description:
      "Search the web with optional Polaris trust scoring. Returns web results with relevance and optional verification.",
    parameters: z.object({
      ...
      verify: z
        .boolean()
        .optional()
        .describe("Enable Polaris trust scoring on results"),
    }),
